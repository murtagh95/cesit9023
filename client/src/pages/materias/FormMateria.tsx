    ...
    return (
      <form onSubmit={handleSubmit(onSubmit)}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <MyDropdown name="duracion" control={control} options={duracion} label="Duracion" />
          </Grid>
          <Grid item xs={12}>
            <MyDropdown name="condicionMateria" control={control} options={condicion} label="Condicion Materia" />
          </Grid>
